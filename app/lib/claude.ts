...
- offer: публичная оферта нужна только если есть онлайн-оплата прямо на сайте (кнопка оплаты, интеграция с платёжной системой). Если сайт принимает заявки/звонки, но оплата происходит офлайн — оферта не обязательна. Не добавляй это нарушение для сайтов услуг без онлайн-оплаты.
